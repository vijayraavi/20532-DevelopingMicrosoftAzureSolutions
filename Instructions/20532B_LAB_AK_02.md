...
5. In the **New** blade that displays, click **Networking** and then click **Virtual Network**.

6. In the **Virtual Network** blade that displays, click **Create**.

7. In the **Virtual network** blade, perform the following steps:

8. In the **Name** dialog box, provide the value **Dev20532**.

9. In the **Location** list, select the region that is closest to your current location.

10. Ensure that the **Address space CIDR block** box has the value **10.0.0.0/16**.

11. In the **Subnet name** box, provide the value **Apps**.

12. Ensure that the **Subnet CIDR block** box has the value **10.0.0.0/24**.

13. In the Resource group box, provide the value **Dev20532**.

14. In the **Virtual network** blade, click **Create**.
...
14. In the **Attach a new disk** blade, perform the following steps:
  ...
  c. In the **Size (GiB)** dialog box, provide the value, **6**.
...
11. In the **Visual Studio Ultimate 2015** dialog box, click **Launch**.
...
####Task 3:	Install Azure SDK for .NET 2.8.1
