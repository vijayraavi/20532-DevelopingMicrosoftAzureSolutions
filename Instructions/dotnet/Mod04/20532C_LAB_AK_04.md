...
6.  Click **Select Source**. Perform the following actions
  ...
  a. In the **New server** blade, click **OK**.

18. In the **SQL database** blade, locate the **Resource group** section and select the existing *20532* resource group.

19. Click **Create** to create the SQL database and server.

19. Write down the server and database names for the new SQL Database instance.
