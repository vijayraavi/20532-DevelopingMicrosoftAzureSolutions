...
> **Note:** For this lab, you will use the Management Portal because the functionality to create new Azure Active Directory domains is not available in the Portal.
...
4.  In the **Solution Explorer** pane, expand the **Administration** folder.
    ...
    ```
    the top of the file:    public class HomeController : Controller
    ```
