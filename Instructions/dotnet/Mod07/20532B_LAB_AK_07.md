...
11. Verify that the text **This is your sample file!** displays in the browser.
    ...
    > **Results**: After completing this exercise, you will have created a blob container by using the Management Portal and viewed the blobs in the container.
...
7.  Point to **Contoso.Events.Cloud** under the **View Sites** header, and then click the URL under the **Browse Applications** header.
