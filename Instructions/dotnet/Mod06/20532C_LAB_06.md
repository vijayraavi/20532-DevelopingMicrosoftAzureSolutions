...
3. Record the *connection string* of the newly created Storage Account instance.
...
1. Start the **Contoso.Events.Worker** project without debugging.

1. Update the **app.config** file in the project to use your *Storage Account*'s connection string in the following locations:
...
1. Debug the **Contoso.Events.Web** project.
...
3.  Open the **EventRegistrations** table in the Azure Storage Account.
