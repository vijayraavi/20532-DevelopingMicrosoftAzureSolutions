...
**CreateDatabaseIfNotExists\<EventsContext\>** inheritance statement to
...
definition looks like the following line of code:
 ...
 public class EventsContextInitializer :
CreateDatabaseIfNotExists\<EventsContext\>


7. Add these **using** statements at
...
10. Within the constructor
**public EventsContext()**, add the following line of code:
...
9. In the Solution Explorer pane,
