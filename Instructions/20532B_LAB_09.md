...
Open the **TableStorageQueueHelper.cs** file in **Contoso.Events.Worker**.
...
1.  Open the **SignInSheetViewModel.cs** file in **Contoso.Events.ViewModels**.
...
Open the **Program.cs** file in the **Contoso.Events.Lodging** project.


Locate the comment that indicates where to place additional service endpoints.

Paste the following code to add a service endpoint for the WCF Relay.
    ...
    sh.AddServiceEndpoint(
        ...
        {
            TokenProvider = TokenProvider.CreateSharedAccessSignatureTokenProvider("RootManageSharedAccessKey", "<put your access key here>")
        });

Locate the **\<put your access key here\>** placeholder in the **CreateSharedAcessSignatureTokenProvider** 
method and replace it with the value from your previously recorded Service Bus connection string.


>  **Note:** For example your connection string maye
> be: Endpoint=sb://contoso.servicebus.windows.net/;\
> SharedAccessKeyName=RootManageSharedAccessKey;\
> SharedAccessKey=ABC123/J3y+tk-Your **SharedAccessKeyName** value would be
> “*RootManageSharedAccessKey*” and your **SharedAcessKey** value would be
> “*ABC123/J3y+tk=”*.
...
Locate the **GetHotelsFromRelay** method.

Locate the line that creates the Uri:
...
Locate the **\<put your access key here\>** placeholder a few lines down and replace it with the value from your previously recorded Service Bus connection string.
...
1.  Copy the **GetHotelsFromRelay** method from the **Program.cs** file.
