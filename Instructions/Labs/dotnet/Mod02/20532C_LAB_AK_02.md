...
9. In the **Create Virtual Machine** blade that displays, click **Summary** and click **Create** to create the virtual machine using your specified configuration.
...
14. In the **Attach a new disk** blade, perform the following steps:
  ...
  g. To create the second disk, click **Save**.
