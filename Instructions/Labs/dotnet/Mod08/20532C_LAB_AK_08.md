...
1.  In the **Browse** blade that displays, click **Service Bus**.

1. At the top of the blad, click the **Add** button.

1. In the **Create Namespace** blad that displays, perform the following steps:
