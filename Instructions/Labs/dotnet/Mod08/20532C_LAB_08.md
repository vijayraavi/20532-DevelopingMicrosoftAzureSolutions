...
1. Create a new **Service Bus** namespace by using the following values:
  ...
  - Location: **Select the region that is closest to you**

  > **Note:** It takes approximately 1-2 minutes to create your Service Bus namespace instance.

1. Note down the connection string for your newly created Service Bus namespace. This can be found under **Shared access policies** 
