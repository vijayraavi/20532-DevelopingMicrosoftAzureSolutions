...
1.  In the **Server Explorer** pane, open the **Storage** node.

1.  Attach your newly created **Storage Account** using the data from the connection information you recorded earlier.
...
2.  Open the **Server Explorer** pane.
