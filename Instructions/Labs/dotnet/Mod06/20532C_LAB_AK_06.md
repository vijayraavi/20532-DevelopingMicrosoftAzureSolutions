...
7.  At the end of the **StoreRegistration** method and before the closing parenthesis, get the connection string by using the **ConfigurationManager.AppSettings** property and the **Microsoft.WindowsAzure.Storage.ConnectionString** value as the parameter:
...
5.  At the end of the **RegisterViewModel** constructor and before the closing parenthesis, get the connection string using the **ConfigurationManager.AppSettings** property and the **Microsoft.WindowsAzure.Storage.ConnectionString** value as the parameter:
